	...
	<div class="container g-piclist" @click="closeHandle">
		<div class="g-return">
			<div class="text">
				...
				<span v-html="onegoods.title"></span>
			</div>
		</div>
		<div class="row">
			...
			<div class="u-content col-sm-5 col-xs-5">
				...
				<div class="m-price">
					<p>价　　格
						<span class="f-price">{{onegoods.price}}</span>
					</p>
					<p>配送服务
						<span class="f-time">16:30前下单 当日发货</span>
					</p>
				</div>
				<p class="u-num">数　　量
					...
					<div class="m-buyma">
						<input type="button" class="f-buyBtn" value="加入购物车" @click="buyHandle(1)" />
...
export default {
	...
	created() {
		...
		this.onegoods = goodsList.filter(item => item.id == gid)[0];
	},
	methods: {
		buyHandle(flag) {
